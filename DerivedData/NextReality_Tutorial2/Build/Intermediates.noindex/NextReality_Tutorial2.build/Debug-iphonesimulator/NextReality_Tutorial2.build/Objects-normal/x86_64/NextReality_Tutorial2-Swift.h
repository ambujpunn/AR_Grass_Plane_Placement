...
SWIFT_MODULE_NAMESPACE_PUSH("NextReality_Tutorial2")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC21NextReality_Tutorial211AppDelegate")
...
SWIFT_CLASS("_TtC21NextReality_Tutorial214ViewController")
